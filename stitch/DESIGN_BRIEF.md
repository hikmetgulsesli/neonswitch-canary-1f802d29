...
- NeonSwitch Canary turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called NeonSwitch Canary. It should be a small full-viewport browser game where the player routes moving light packets through a neon switch grid, flips switches with keyboard or click controls, avoids dead rails, and can open a settings overlay without leaving gameplay. Include…
...
- Gameplay - NeonSwitch Canary
- Game Settings - NeonSwitch Canary

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - NeonSwitch Canary
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - NeonSwitch Canary
